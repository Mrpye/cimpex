...
var rootCmd = &cobra.Command{
	Use:   "cimpex",
	Short: "cimpex is a utility to import and export images from a container registry",
	Long:  `cimpex is a utility to import and export images from a container registry.`,
}
